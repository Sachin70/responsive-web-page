            ...
            <div className="md:w-2/4 px-14">
                <div className="md:max-w-xl md:mx-auto md: my-0 flex flex-col gap-y-6 md:gap-y-44 relative justify-center items-center md:items-start h-full">
                    <div className="flex flex-col gap-y-5 items-center md:items-start">
                        <p className="text-primary font-semibold text-sm leading-6 md:font-normal md:text-3xl md:leading-72 md:text-white uppercase md:normal-case">
                            Olvera Guides
                        </p>

                        <div className="md:hidden font-semibold text-2xl text-white">Careers at Olvera</div>
                    ...
                    <p className="text-white font-normal text-base text-center md:text-left">
